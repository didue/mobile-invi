...
export const NOTICES = [
  {
    ...
    items: [
      ...
      '갈비탕을 포함하여 음식 리필이 가능합니다. (제외:전복/칠리새우/모듬회)<br/>가까운 직원에게 편하게 문의해 주세요.',
      '꼭 4인으로 앉지 않으셔도 됩니다.<br/>합석을 원치 않으시거나 1인상을 원하시는 분께서는 직원에게 편하게 말씀해주세요.',
      '5세 이하의 어린이는 어린이 식권을 받아주시기 바랍니다.<br/>(6세 이상의 어린이는 성인과 동일)',
    ],
  },
  {
    title: '주차안내',
